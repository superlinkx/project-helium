...
function keyUp(a){a.keyCode==68?rightKey=!1:a.keyCode==65&&(leftKey=!1);a.keyCode==87?upKey=!1:a.keyCode==83&&(downKey=!1)}function continueButton(a){var b=getCursorPos(a);if(b.x>w/2-53&&b.x<w/2+47&&b.y>h/2+10&&b.y<h/2+50||a.keyCode==13)alive=!0,lives=3,score=0,speed=3,reset(),canvas.removeEventListener("click",continueButton,!1)}
