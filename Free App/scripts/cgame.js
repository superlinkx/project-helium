...
function gameLoop(){canvas.width = canvas.width;backgroundDraw();alive&&gameStarted&&lives>0&&(moveEnemy1(),moveLaser(),drawEnemy1(),laserFire(),drawLaser(),playerDraw(),hitTest(),shipCollision(),lvlchecker());scoreTotal();game=setTimeout(gameLoop,1E3/FPS)}window.onload=init;
